    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb', fontFamily: 'Arial, sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ background: 'white', borderRadius: '1rem', boxShadow: '0 1px 3px 0 rgba(0,0,0,0.1)', padding: '2rem 3rem', display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: '320px' }}>
                <Image src={user.picture || '/img/Logo_Orang.png'} alt="Foto Profil" width={80} height={80} style={{ borderRadius: '50%', objectFit: 'cover', marginBottom: '1rem' }} />
                <h2 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 'bold', fontSize: '1.3rem', margin: 0 }}>{user.name}</h2>
                <p style={{ color: '#6b7280', fontFamily: 'Poppins, sans-serif', margin: '0.5rem 0 1.5rem 0', fontSize: '1rem' }}>{user.email}</p>
