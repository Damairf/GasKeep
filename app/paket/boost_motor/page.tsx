            ...
            <main style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <Image 
                            src="/img/banner_motor_boost.png" 
                            alt="Paket Motor Boost" 
                            fill
                            style={{
                                objectFit: 'cover'
                            }}
                    ...
                    <div style={{
                        ...
                        <p style={{
                            ...
                            Paket tengah untuk penitipan motor dengan layanan perawatan, keamanan terjamin dan pencucian motor.
                        </p>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <button id='boost-motor-button' style={{
                            padding: '0.75rem 1.5rem',
                        ...
                        onClick={() => window.location.href = '/detail_pemesanan?paket=boost-motor-button'}
                        >
                            Pesan Sekarang
                        </button>
                    </div>
