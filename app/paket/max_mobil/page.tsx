            ...
            <main style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p style={{
                            ...
                            Paket maksimum untuk penitipan mobil dengan layanan perawatan, keamanan terjamin, pencucian mobil serta penjemputan dan pengantaran mobil.
                        </p>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <button id='max-mobil-button' style={{
                            padding: '0.75rem 1.5rem',
                        ...
                        onClick={() => window.location.href = '/detail_pemesanan?paket=max-mobil-button'}
                        >
                            Pesan Sekarang
                        </button>
                    </div>
