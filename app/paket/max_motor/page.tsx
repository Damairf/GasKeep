            ...
            <main style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p style={{
                            ...
                            Paket maksimum untuk penitipan motor dengan layanan perawatan, keamanan terjamin, pencucian motor serta penjemputan dan pengantaran motor.
                        </p>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <button id='max-motor-button' style={{
                            padding: '0.75rem 1.5rem',
                        ...
                        onClick={() => window.location.href = '/detail_pemesanan?paket=max-motor-button'}
                        >
                            Pesan Sekarang
                        </button>
                    </div>
