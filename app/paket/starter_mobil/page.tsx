            ...
            <main style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p style={{
                            ...
                            Paket dasar untuk penitipan mobil dengan layanan perawatan dan keamanan terjamin.
                        </p>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        onClick={() => window.location.href = '/detail_pemesanan?paket=starter-mobil-button'}
                        >
                            Pesan Sekarang
                        </button>
                    </div>
