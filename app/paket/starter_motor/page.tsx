            ...
            <main style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <Image 
                            src="/img/banner_motor_starter.png" 
                            alt="Paket Motor Starter"
                            fill
                            style={{
                                objectFit: 'cover'
                            }}
                    ...
                    <div style={{
                        ...
                        <p style={{
                            ...
                            Paket dasar untuk penitipan motor dengan layanan perawatan dan keamanan terjamin.
                        </p>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <button id='starter-motor-button' style={{
                            padding: '0.75rem 1.5rem',
                        ...
                        onClick={() => window.location.href = '/detail_pemesanan?paket=starter-motor-button'}
                        >
                            Pesan Sekarang
                        </button>
                    </div>
